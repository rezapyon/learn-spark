...
public class VPPChapterViewsLogistic {
    public static void main(String[] args) {
        ...
        SparkSession spark = SparkSession.builder().appName("VPP Chapter Views Logistic").master("local[*]").getOrCreate();
        ...
        Dataset<Row> inputData = vectorAssembler.setInputCols(new String[] {"firstSub", "age", "all_time_views", "last_month_views", "payVector", "countryVector", "periodVector"})
        ...
        System.out.println("For the holdout data, the likelyhood of a positive being correct is " + truePositives / (truePositives + falsePositives));
